...
<head>
    ...
    <title>Pacifico - Multipurpose Landing Page</title>
    ...
    <link href="<?php echo base_url('assets/css/style-magnific-popup.css'); ?>" rel="stylesheet">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <!--logo -->
                    <a href="index.html" class="navbar-brand" id="logo">Pacifico</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <img src="http://placehold.it/600x500" alt="app-image" class="width-100">
		...
		<div class="container	">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<img src="http://placehold.it/555X510" alt="img" class="width-100 wow fadeInUp" data-wow-delay="0.25s">
				...
				<div class="col-md-6">
					...
					<p class="section-subtitle white">There are many variations of passages of Lorem Ipsum available, but majority have suffered alteration by new randomised words.</p>
				...
				<div class="col-md-4 col-sm-4">
					...
					<div class="price-box-blue">
						...
						<ul class="pricing-list">
							...
							<li class="price-text white-text">All Experiences</li>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-item-inner">
                            ...
                            <a href="#" class="btn btn-lg btn-blue small">Read More!</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <p>Copyright © 2018 Focus. Designed by <a href="https://themeforest.net/user/epic-themes/portfolio?ref=Epic-Themes" target="_blank">Epic-Themes</a></p>
